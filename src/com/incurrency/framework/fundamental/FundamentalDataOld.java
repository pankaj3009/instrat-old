 ...
 * @author admin
 */
public class FundamentalDataOld implements Runnable, FundamentalDataListener {
    ...
    private static final Logger logger=Logger.getLogger(FundamentalDataOld.class.getName());

    public FundamentalDataOld() {
