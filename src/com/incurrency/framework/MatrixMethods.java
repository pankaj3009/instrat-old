...
public static DoubleMatrix ref(DoubleMatrix m, DoubleMatrix mshift) {
 ...
 /**
 * Returns the highest value of matrix m, since "expression" was true on the "index"th most recent occurrence
 * @param expression
 * @param m
 * @param index
 * @return 
 */
        ...
        /**
         * Returns the lowest value of matrix m, since "expression" was true on the "index"th most recent occurrence
         * @param expression
         * @param m
         * @param index
         * @return 
   ...
   /**
    * Creates a doublematrix of 1 row and specified columns, filled with value of i
    * @param i
    * @param size
    * @return 
    */
   ...
   /**
    * removes excessive signals:returns 1 on the first occurence of "true" signal in a1,then returns 0
    * until a2 is true even if there are "true" signals in a1
    * @param a1
    * @param a2
    * @return 
    */
